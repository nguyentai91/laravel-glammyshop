	...
	<div class="clearfix">
		<div class="tovar_view_fotos clearfix">
			<div id="slider1" class="flexslider">
				<ul class="slides">
					<li><a href="javascript:void(0);" ><img src="images/tovar/women/1.html" alt="" /></a></li>
					<li><a href="javascript:void(0);" ><img src="images/tovar/women/1_2.html" alt="" /></a></li>
					<li><a href="javascript:void(0);" ><img src="images/tovar/women/1_3.html" alt="" /></a></li>
					<li><a href="javascript:void(0);" ><img src="images/tovar/women/1_4.html" alt="" /></a></li>
				</ul>
			</div>
