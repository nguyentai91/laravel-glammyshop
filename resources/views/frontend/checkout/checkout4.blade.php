            ...
            <div class="col-lg-9 col-md-9 padbot60">
                <div class="checkout_confirm_orded clearfix">
                    ...
                    <div class="checkout_confirm_orded_products">
                        ...
                        <ul class="cart-items">
                            <li class="clearfix">
                                <img class="cart_item_product" src="assets/frontend/images/tovar/women/1.jpg" alt="" />
                                <a href="product-page.html" class="cart_item_title">EMBROIDERED BIB PEASANT TOP</a>
                                <span class="cart_item_price">$88.00</span>
                            </li>
                            <li class="clearfix">
                                <img class="cart_item_product" src="assets/frontend/images/tovar/women/2.jpg" alt="" />
                            ...
                            <li class="clearfix">
                                <img class="cart_item_product" src="assets/frontend/images/tovar/women/3.jpg" alt="" />
