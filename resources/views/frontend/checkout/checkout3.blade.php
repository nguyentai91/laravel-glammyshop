                ...
                <div class="payment_method padbot70">
                    ...
                    <ul class="clearfix">
                        <li>
                            ...
                            <label for="ridio1">Visa<br><img src="assets/frontend/images/visa.jpg" alt="" /></label>
                        </li>
                        <li>
                            <input id="ridio2" type="radio" name="radio" hidden />
                            <label for="ridio2">Master Card<br><img src="assets/frontend/images/master_card.jpg" alt="" /></label>
                        </li>
                        <li>
                            <input id="ridio3" type="radio" name="radio" hidden />
                            <label for="ridio3">PayPal<br><img src="assets/frontend/images/paypal.jpg" alt="" /></label>
                        </li>
                        <li>
                            <input id="ridio4" type="radio" name="radio" hidden />
                            <label for="ridio4">Discover<br><img src="assets/frontend/images/discover.jpg" alt="" /></label>
                        </li>
                        <li>
                            <input id="ridio5" type="radio" name="radio" hidden />
                            <label for="ridio5">Skrill<br><img src="assets/frontend/images/skrill.jpg" alt="" /></label>
                        </li>
                    </ul>
                </div>
